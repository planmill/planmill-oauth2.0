...
const { setupOAuth2Strategy } = require("./passportConfig");
...
function createAuthHandler() {
    ...
    router.post("/login", async (req, res) => {
        const { client_id, client_secret, callback_url, auth_type, instance } = req.body;
        ...
        if (auth_type === "authorization_code") {
            setupOAuth2Strategy({ client_id, client_secret, callback_url, instance});
